...
float Kp = 15, Kd = 50, Ki = 0.004; //Constantes multiplicativas para o PID

float I = 0, erro_anterior = 0;
int velocidade = 89; //Velocidade para os motores (pode e deve ser ajustada) OBS: 60 da bom
uint8_t velocidade_maxima = 90; //90 deu bom
